...
export class ResultsService {
   ...
   * @param year 
   * @param classId 
   * @returns Array of result records containing studentName, profilePic, percentage, and className
   *
   * @throws InternalServerErrorException If year is invalid or query fails
   */
...
// Query the database
    try 
    {
      const rows = await this.db
        ...
        .orderBy('r.entrydate', 'desc').execute();
